...
#ifndef __KTUX_CTYPE_H
#define __KTUX_CTYPE_H
...
#define ispunct(c)	((unsigned)(c) & (CT_PUN))
#define isspace(c)	((unsigned)(c) & (CT_WHT))
#define isupper(c)	((unsigned)(c) & (CT_UP))
#define isxdigit(c)	((unsigned)(c) & (CT_DIG | CT_HEX))
